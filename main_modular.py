...
def ensure_output_directories():
    ...
    directories = [
        ...
        'semi_auto_label_demo/data', 
        'semi_auto_label_demo/outputs',
        'semi_auto_label_demo/logs'
    ]
...
def stage1_data_generation() -> List[Dict[str, Any]]:
    ...
    # Save raw dataset
    save_results(dataset, 'semi_auto_label_demo/data/raw_dataset.csv')
    
    print(f"✅ Generated {len(dataset)} synthetic text samples")
    print(f"📁 Saved to: semi_auto_label_demo/data/raw_dataset.csv")
...
def stage2_llm_labeling(dataset: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    llm_results = generate_labels(texts, gold_labels, noise_rate=0.15)
    
    # Save LLM annotations
    save_results(llm_results, 'semi_auto_label_demo/data/llm_annotations.csv')
    ...
    print(f"📁 Saved to: semi_auto_label_demo/data/llm_annotations.csv")
...
def stage3_rule_validation(llm_results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    save_results(rule_results, 'semi_auto_label_demo/data/rule_checked.csv')
    ...
    print(f"📁 Saved to: semi_auto_label_demo/data/rule_checked.csv")
...
def stage4_ml_validation(rule_results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    save_results(ml_results, 'semi_auto_label_demo/data/ml_validated.csv')
    ...
    print(f"📁 Saved to: semi_auto_label_demo/data/ml_validated.csv")
...
def stage5_human_review(ml_results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    # Save final results
    save_results(final_results, 'semi_auto_label_demo/outputs/final_labeled_dataset.csv')
    ...
    print(f"📁 Saved to: semi_auto_label_demo/outputs/final_labeled_dataset.csv")
...
def stage6_evaluation_and_visualization(final_results: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    chart_path = generate_visualizations(final_results, 'semi_auto_label_demo/outputs')
    
    # Save metrics summary
    save_metrics_summary(metrics, workload_stats, 'semi_auto_label_demo/outputs/metrics_summary.txt')
    
    print(f"📊 Evaluation metrics calculated")
    print(f"📈 Visualizations generated: {chart_path}")
    print(f"📄 Metrics summary: semi_auto_label_demo/outputs/metrics_summary.txt")
...
def main():
    ...
    logger = setup_logging("INFO", "semi_auto_label_demo/logs/system.log")
    
    print("🚀 SEMI-AUTOMATED DATA LABELING SYSTEM")
    print("="*80)
    print("Starting comprehensive labeling pipeline...")
    print("All outputs will be saved to: semi_auto_label_demo/")
    ...
    try:
        ...
        print(f"\n📁 All outputs saved to: semi_auto_label_demo/")
        print("📋 Files generated:")
        print("  📊 data/raw_dataset.csv - Original synthetic dataset")
        print("  🤖 data/llm_annotations.csv - LLM predictions")
        print("  📋 data/rule_checked.csv - Rule-validated results")
        print("  🎯 data/ml_validated.csv - ML-validated results")
        print("  ✅ outputs/final_labeled_dataset.csv - Final corrected dataset")
        print("  📈 outputs/label_comparison.png - Visualization charts")
        print("  📄 outputs/metrics_summary.txt - Comprehensive metrics")
        print("  📝 logs/system.log - System execution log")
